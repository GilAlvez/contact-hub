const tokens = {
  ...
  "colors.primary.main": {
    ...
    "variable": "var(--colors-primary-main)"
  },
  "colors.primary.dark": {
  ...
  "colors.colorPalette.xlighter": {
    "value": "var(--colors-color-palette-xlighter)",
    "variable": "var(--colors-color-palette-xlighter)"
  },
